...
class ModeBar extends React.Component {
    render() {
      return(
        ...
        <a className={"modebar-btn" + (this.props.mode === AppMode.FEED ? " item-selected" : null)}
        ...
        <a className={"modebar-btn" + (this.props.mode === AppMode.ROUNDS ? " item-selected" : null)}
           onClick={()=>this.props.changeMode(AppMode.ROUNDS)}>
          <span className="modebar-icon  fa fa-history"></span>
          <span className="modebar-text">Rounds</span>
        </a>
        <a className={"modebar-btn" + (this.props.mode === AppMode.COURSES ? " item-selected" : null)}
